...
namespace AwsApi.Atom
{
	...
	/// </summary>
	[Serializable]
	public sealed class AtomRequestId : Atom
	{
		...
		private AtomRequestId(XElement element)
			: base(element, AtomRequestId.xmlPrefix, AtomRequestId.xmlName)
		{
		...
		public static AtomRequestId Parse(XElement element)
		{
			// If the XML element is null, return null.
			if (null == element) return null;
			// Else, return a new atom object.
			return new AtomRequestId(element);
		}
		...
		public static AtomRequestId ParseChild(XElement element)
		{
			...
			return AtomRequestId.Parse(element.Element(AtomRequestId.xmlPrefix, AtomRequestId.xmlName));
		}
