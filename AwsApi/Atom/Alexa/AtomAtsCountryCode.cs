...
{
	/// <summary>
	/// A class representing an AWS country code atom object.
	/// </summary>
	[Serializable]
	public sealed class AtomAtsCountryCode : Atom
	{
		internal const string xmlPrefix = "aws";
		internal const string xmlName = "CountryCode";

		/// <summary>
		/// Creates a new atom instance from the specified XML element.
		/// </summary>
		/// <param name="element">The XML element.</param>
		private AtomAtsCountryCode(XElement element)
			: base(element, AtomAtsCountryCode.xmlPrefix, AtomAtsCountryCode.xmlName)
		{
		...
		public static AtomAtsCountryCode Parse(XElement element)
		{
			// If the XML element is null, return null.
			if (null == element) return null;
			// Else, return a new atom object.
			return new AtomAtsCountryCode(element);
		}
		...
		public static AtomAtsCountryCode ParseChild(XElement element)
		{
			...
			return AtomAtsCountryCode.Parse(element.Element(AtomAtsCountryCode.xmlPrefix, AtomAtsCountryCode.xmlName));
		}
