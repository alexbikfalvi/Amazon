...
{
	/// <summary>
	/// A class representing an AWS rank atom object.
	/// </summary>
	[Serializable]
	public sealed class AtomAtsRank : Atom
	{
		internal const string xmlPrefix = "aws";
		internal const string xmlName = "Rank";

		/// <summary>
		/// Creates a new atom instance from the specified XML element.
		/// </summary>
		/// <param name="element">The XML element.</param>
		private AtomAtsRank(XElement element)
			: base(element, AtomAtsRank.xmlPrefix, AtomAtsRank.xmlName)
		{
		...
		public static AtomAtsRank Parse(XElement element)
		{
			// If the XML element is null, return null.
			if (null == element) return null;
			// Else, return a new atom object.
			return new AtomAtsRank(element);
		}
		...
		public static AtomAtsRank ParseChild(XElement element)
		{
			...
			return AtomAtsRank.Parse(element.Element(AtomAtsRank.xmlPrefix, AtomAtsRank.xmlName));
		}
	}
}
