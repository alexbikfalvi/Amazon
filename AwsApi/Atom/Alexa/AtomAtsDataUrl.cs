...
{
	/// <summary>
	/// A class representing an AWS data URL atom object.
	/// </summary>
	[Serializable]
	public sealed class AtomAtsDataUrl : Atom
	{
		internal const string xmlPrefix = "aws";
		internal const string xmlName = "DataUrl";

		/// <summary>
		/// Creates a new atom instance from the specified XML element.
		/// </summary>
		/// <param name="element">The XML element.</param>
		private AtomAtsDataUrl(XElement element)
			: base(element, AtomAtsDataUrl.xmlPrefix, AtomAtsDataUrl.xmlName)
		{
		...
		public static AtomAtsDataUrl Parse(XElement element)
		{
			// If the XML element is null, return null.
			if (null == element) return null;
			// Else, return a new atom object.
			return new AtomAtsDataUrl(element);
		}
		...
		public static AtomAtsDataUrl ParseChild(XElement element)
		{
			...
			return AtomAtsDataUrl.Parse(element.Element(AtomAtsDataUrl.xmlPrefix, AtomAtsDataUrl.xmlName));
		}
