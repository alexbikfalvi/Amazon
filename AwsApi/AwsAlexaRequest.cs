...
namespace AwsApi
{
	...
	public sealed class AwsAlexaRequest : AsyncWebRequest
	{
			...
			ResponseGroup responseGroup)
		{
			...
			builderQuery.AppendFormat("&Timestamp={0}", "2013-07-25T10%3A25%3A41.770Z");//Uri.EscapeDataString(DateTime.UtcNow.ToString("o")));
			*/
			
			builderQuery.Append("AWSAccessKeyId=AKIAJH47JLHRJ4S57FFA&Action=TopSites&Count=2&CountryCode=&ResponseGroup=ListCities&SignatureMethod=HmacSHA256&SignatureVersion=2&Start=1&Timestamp=2013-07-25T10%3A40%3A41.770Z");
